...
- **CONFIRMADO** — Fotografias do advogado fornecidas pelo usuário. Em uso: recorte sem fundo em preto e branco na hero (`retrato-advogado.png`) e foto ambientada no escritório, à mesa e com a biblioteca jurídica ao fundo, na seção "Quem conduz o trabalho" (`escritorio-advogado.webp`, do arquivo IZA07558 da série "ESCRITÓRIO - CORES CINEMATOGRÁFICAS", com 14% do topo cortados no enquadramento). A versão colorida do recorte (`retrato-advogado-cor.webp`) continua na pasta, mas fora de uso.
